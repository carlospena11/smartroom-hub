      ...
      <div className="border-t border-sidebar-border">
        <div className="p-4">
          <div className="flex items-center gap-2 mb-3">
            <Star className="h-4 w-4 text-sidebar-foreground/60" />
            <span className="text-sm font-medium text-sidebar-foreground">Acceso Rápido</span>
          </div>
          ...
          <div className="space-y-1">
            ...
            >
              <Smartphone className="h-3 w-3 text-sidebar-foreground/40 group-hover:text-sidebar-accent-foreground" />
            ...
            <Link
              ...
              className="flex items-center gap-2 p-2 rounded-md hover:bg-sidebar-accent transition-colors group"
            >
              <FolderOpen className="h-3 w-3 text-sidebar-foreground/40 group-hover:text-sidebar-accent-foreground" />
              <div className="text-xs font-medium text-sidebar-foreground/80">
